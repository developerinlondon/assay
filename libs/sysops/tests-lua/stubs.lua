...
--!
--! Used by libs/sysops/tests-lua/smoke.test.lua.
...
function M.opts(overrides)
  ...
  return {
    ...
    lib_root           = overrides.lib_root or "libs/sysops",
    ...
    backup_profile_dir   = overrides.backup_profile_dir or "/tmp/sysops-smoke-no-profile",
