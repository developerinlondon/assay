--! sysops.vault - helpers for Assay Engine Vault integration.
--!
--! `secret_store(opts)` returns the `read/write/delete/available`
--! table shape consumed by sysops backup services. It stores host/app
--! operational secrets in assay-engine KV v2 and keeps legacy
--! read-only file fallbacks for existing backup profiles.
