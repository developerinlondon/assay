...
-- Old API: M.get_resource(), M.list(), M.get_secret(), etc. still work.

function M.get_resource(namespace, kind, name, opts)
  return M.resources:get(namespace, kind, name, opts)
end

function M.list(namespace, kind, opts)
  return M.resources:list(namespace, kind, opts)
end

function M.create(namespace, kind, body, opts)
  return M.resources:create(namespace, kind, body, opts)
end

function M.update(namespace, kind, name, body, opts)
  return M.resources:update(namespace, kind, name, body, opts)
end

function M.patch_resource(namespace, kind, name, body, opts)
  return M.resources:patch(namespace, kind, name, body, opts)
end

function M.delete_resource(namespace, kind, name, opts)
  return M.resources:delete(namespace, kind, name, opts)
end

function M.exists(namespace, kind, name, opts)
  return M.resources:exists(namespace, kind, name, opts)
end

function M.get_secret(namespace, name, opts)
  return M.secrets:get(namespace, name, opts)
end

function M.get_configmap(namespace, name, opts)
  return M.configmaps:get(namespace, name, opts)
end

function M.list_pods(namespace, opts)
  return M.pods:list(namespace, opts)
end

function M.list_events(namespace, opts)
  return M.events:list(namespace, opts)
end

function M.pod_status(namespace, opts)
  return M.pods:status(namespace, opts)
end

function M.is_ready(namespace, kind, name, opts)
  return M.resources:is_ready(namespace, kind, name, opts)
end

function M.wait_ready(namespace, kind, name, timeout_secs, opts)
  return M.resources:wait_ready(namespace, kind, name, timeout_secs, opts)
end

function M.service_endpoints(namespace, name, opts)
  return M.services:endpoints(namespace, name, opts)
end

function M.logs(namespace, pod_name, opts)
  return M.pods:logs(namespace, pod_name, opts)
end

function M.rollout_status(namespace, name, opts)
  return M.deployments:rollout_status(namespace, name, opts)
end

function M.node_status(opts)
  return M.nodes:status(opts)
end

function M.namespace_exists(name, opts)
  return M.namespaces:exists(name, opts)
end

function M.events_for(namespace, kind, name, opts)
  return M.events:for_resource(namespace, kind, name, opts)
end
