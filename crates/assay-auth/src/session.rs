...
async fn mint_session_response(ctx: &AuthCtx, user_id: &str, email: Option<String>) -> Response {
...
mod tests {
    ...
    async fn auth_start_uses_server_store_not_client_input() {
        ...
        let ctx = AuthCtx::new(users.clone(), sessions).with_passkeys(test_passkey_manager(users));
