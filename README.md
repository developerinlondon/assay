...
| `assay.workflow` |  |
| **AI & Agents** | |
| `assay.neutron` | Neutron self-hosted agent platform — the admin API, the CRM (campaigns, people, inbox, held sends, fleet, deals, claims) and the work tracker, from Lua |
| **Cloud & AWS** | |
| `assay.aws-ec2` |  |
| `assay.aws-ecr` |  |
| `assay.aws-s3` |  |
...
| `assay.system` |  |
| **Registries** | |
| `assay.apify` | Apify actor runs behind a mandatory spend cap — start, wait, read the dataset and what it cost; typed Instagram, LinkedIn and contact-details readers |
